...
userRouter.get("/users/me", userAuth, (req, res) => {
  try {
    const user = req.user;
...
userRouter.get("/users/search", userAuth, authorize("admin"), async (req, res) => {
...
userRouter.get("/users", userAuth, authorize("admin"), async (req, res) => {
  try {
...
userRouter.post("/users/verify-password", userAuth, async (req, res) => {
...
userRouter.patch("/users/change-password", userAuth, async (req, res) => {
...
userRouter.patch("/users/:id/profile-image", userAuth, async (req, res) => {
  const { id } = req.params;
...
userRouter.patch("/users/:id/verify", userAuth, authorize("admin"), async (req, res) => {
  const { id } = req.params;
  try {
    if (!id) {
...
userRouter.patch("/users/:id", userAuth, async (req, res) => {
  const { id } = req.params;
  const data = { ...req.body };
...
userRouter.delete("/users/:id", userAuth, authorize("admin"), async (req, res) => {
  const { id } = req.params;
